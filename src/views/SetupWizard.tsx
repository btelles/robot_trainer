                ...
                <div className="mt-4 p-3 rounded-md bg-white">
                  ...
                  <div className="mt-4 p-3 border rounded-md bg-white">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Button
                        variant="ghost"
                        onClick={checkAnaconda}
                        disabled={anacondaScanning}
                      >
                        {anacondaScanning ? "Detecting…" : "Detect Anaconda"}
                      </Button>
                    </div>
                    {anacondaError && (
                      <div className="text-sm text-red-600 mb-2">
                    ...
                    {!anacondaResult && (
                      <div className="text-sm text-gray-500">
                        Click "Detect Anaconda" to look for a local Anaconda
                        installation.
                      </div>
                    )}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="space-y-1 mt-2">
                          {anacondaResult.envs.length === 0 && (
                            <div className="space-y-2">
                              <div className="text-sm text-gray-500">
                                No environments found in the Anaconda envs
                                directory. <br />
                                We recommend that you have a dedicated
                                environment for Robot Trainer.
                                <br />
                                Would you like us to create one called{" "}
                                <span className="font-mono">robot_trainer</span>
                                ?
                              </div>
                              <div className="flex items-center gap-3">
                                <Button
                                  onClick={() =>
                                    createAnacondaEnv("robot_trainer")
                                  }
                                ...
                                <Button
                                  ...
                                  onClick={() => {
                                    window.dispatchEvent(
                                      new CustomEvent("robottrainer:navigate", {
                                        detail: "system-settings",
                                      })
                                    );
                                  }}
                                >
                                  No, point to custom Python
                                </Button>
                              </div>
                            </div>
                          )}
                          ...
                          {anacondaResult.envs.map((envObj) => (
                            ...
                            >
                              <input
                                type="radio"
                                name="condaEnv"
                                checked={selectedCondaEnv === envObj.name}
                                onChange={() =>
                                  setSelectedCondaEnv(envObj.name)
                                }
                              />
                        ...
                        <div className="flex items-center gap-3">
                          <Button
                            onClick={openConfirmForSelectedEnv}
                            disabled={!selectedCondaEnv}
                          >
                    ...
                    {anacondaResult && !anacondaResult.found && (
                      <div className="space-y-2">
                        <div className="text-sm">
                          No Anaconda installation detected in your home
                          directory.
                        </div>
                        <div className="flex items-center gap-3">
                          <Button
                        ...
                        <div className="text-sm text-gray-600">
                          Anaconda is recommended for machine learning workflows
                          used by Robot Trainer.
                        </div>
                      </div>
                    )}
                  </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-md shadow-lg w-96 p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Please confirm the Python executable that will be used by Robot
              Trainer.
            </p>
            <div className="p-3 mb-4 bg-gray-50 border rounded text-sm font-mono break-all">
              {confirmPythonPath ||
                "No Python executable detected for this environment."}
            </div>
            <div className="flex justify-end gap-3">
              ...
              <Button
                onClick={confirmSavePythonPath}
                disabled={!confirmPythonPath}
              >
                Confirm
              </Button>
            </div>
